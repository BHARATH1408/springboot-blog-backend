...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            System.out.println("⚠️ Malformed JWT: " + e.getMessage());
        } catch (io.jsonwebtoken.SignatureException e) {
            System.out.println("⚠️ Invalid JWT signature: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("⚠️ Unknown JWT error: " + e.getMessage());
        }

        // If token invalid or username not found -> skip authentication
